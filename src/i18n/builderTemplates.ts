...
export function getBuilderTemplate(lang: string): BuilderTemplateData {
    if (lang === 'it') {
        const templateDataIt: BuilderTemplateData = {
            ...
            prefermentIngredientsDay2Label: "Ingredienti per il Rinfresco (Giorno 2)",
            ...
            builderIntroTitle: "Scegli il tuo stile di impasto",
        ...
        const templateDataEng: BuilderTemplateData = {
            ...
            prefermentIngredientsDay2Label: "Ingredients for Refresh (Day 2)",
            ...
            builderIntroTitle: "Choose your dough style",
